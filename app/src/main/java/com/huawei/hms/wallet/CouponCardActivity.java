...
public class CouponCardActivity extends Activity implements HuaweiApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //Urllist
                EditText couponUrlLable = findViewById(R.id.couponUrlLable);
                EditText couponUrlValue = findViewById(R.id.couponUrlValue);
                EditText couponUrlLable1 = findViewById(R.id.couponUrlLable1);
                EditText couponUrlValue1 = findViewById(R.id.couponUrlValue1);
                ArrayList<AppendField> urlList = new ArrayList<>();
                urlList.add(AppendField.getBuilder()
                        .setKey("1")
                        .setLabel(couponUrlLable.getText().toString())
                        .setValue(couponUrlValue.getText().toString())
                        .build());
                urlList.add(AppendField.getBuilder()
                        .setKey("2")
                        .setLabel(couponUrlLable1.getText().toString())
                        .setValue(couponUrlValue1.getText().toString())
                        .build());
    ...
    private void initDefaultData(int environment) {
        EditText passStyleIdentifier = findViewById(R.id.passStyleIdentifierCoupon);
        TextView passTypeId = findViewById(R.id.typeIdentifierCoupon);
        TextView issuerIdView = findViewById(R.id.issuerIdCoupon);
        switch (environment) {
            case Constant.ENVIRMENT_EUROPE_RELEASE:
                issuerIdView.setText("101511713");
                passTypeId.setText("hwpass.walletkit.offer.srceu");
                passStyleIdentifier.setText("class_offer_01");
                break;
            case Constant.ENVIRMENT_AFIRA_RELEASE:
                issuerIdView.setText("101507583");
                passTypeId.setText("hwpass.walletkit.offer.src");
                passStyleIdentifier.setText("class_offer_01");
                break;
