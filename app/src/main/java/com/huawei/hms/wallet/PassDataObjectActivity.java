...
public class PassDataObjectActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                EditText currency = findViewById(R.id.loyaltyCurrency);
                passBuilder.setCurrencyCode(currency.getText().toString());
                ...
                //Urllist
                EditText loyaltyUrlLable = findViewById(R.id.loyaltyUrlLable);
                EditText loyaltyUrlValue = findViewById(R.id.loyaltyUrlValue);
                EditText loyaltyUrlLable1 = findViewById(R.id.loyaltyUrlLable1);
                EditText loyaltyUrlValue1 = findViewById(R.id.loyaltyUrlValue1);
                ArrayList<AppendField> urlList = new ArrayList<>();
                urlList.add(AppendField.getBuilder()
                        .setKey("1")
                        .setLabel(loyaltyUrlLable.getText().toString())
                        .setValue(loyaltyUrlValue.getText().toString())
                        .build());
                urlList.add(AppendField.getBuilder()
                        .setKey("2")
                        .setLabel(loyaltyUrlLable1.getText().toString())
                        .setValue(loyaltyUrlValue1.getText().toString())
                        .build());
                ...
                locationList.add(new Location(longitudeStr1,latitudeStr1));
    ...
    /**
     * Set different default values based on the selected environment
     *
     * @param environment Environmental index
     */
    private void initDefaultData(int environment) {
        EditText passStyleIdentifier = findViewById(R.id.passStyleIdentifier);
        TextView passTypeId = findViewById(R.id.passTypeId);
        TextView issuerIdView = findViewById(R.id.issuerId);
        switch (environment) {
            case Constant.ENVIRMENT_EUROPE_RELEASE:
                issuerIdView.setText("101511713");
                passTypeId.setText("hwpass.walletkit.loyalty.srceu");
                passStyleIdentifier.setText("class_loyalty_01");
                break;
            case Constant.ENVIRMENT_AFIRA_RELEASE:
                issuerIdView.setText("101507583");
                passTypeId.setText("hwpass.walletkit.loyalty.src");
                passStyleIdentifier.setText("class_loyalty_01");
                break;
            case Constant.ENVIRMENT_RUSSIA_RELEASE:
                issuerIdView.setText("101476483");
                passTypeId.setText("hwpass.walletkit.loyalty.src");
                passStyleIdentifier.setText("class_loyalty_01");
                break;
            default:
