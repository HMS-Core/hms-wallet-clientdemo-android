...
public class GiftCardActivity extends Activity implements HuaweiApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //giftCurrency
                EditText giftCurrencyEdit = findViewById(R.id.giftCurrency);
                passBuilder.setCurrencyCode(giftCurrencyEdit.getText().toString());
             ...
             //   EditText passBarcodeType = findViewById(R.id.passBarcodeType);
               ...
               switch (barCodeStyleList.get(barCodeStyleIndex)) {
                ...
                //Urllist
                EditText giftUrlLable = findViewById(R.id.giftUrlLable);
                EditText giftUrlValue = findViewById(R.id.giftUrlValue);
                EditText giftUrlLable1 = findViewById(R.id.giftUrlLable1);
                EditText giftUrlValue1 = findViewById(R.id.giftUrlValue1);
                ArrayList<AppendField> urlList = new ArrayList<>();
                urlList.add(AppendField.getBuilder()
                        .setKey("1")
                        .setLabel(giftUrlLable.getText().toString())
                        .setValue(giftUrlValue.getText().toString())
                        .build());
                urlList.add(AppendField.getBuilder()
                        .setKey("2")
                        .setLabel(giftUrlLable1.getText().toString())
                        .setValue(giftUrlValue1.getText().toString())
                        .build());
    ...
    private void initDefaultData(int environment) {
        EditText passStyleIdentifier = findViewById(R.id.passStyleIdentifierGift);
        TextView passTypeId = findViewById(R.id.passTypeIdentifier);
        TextView issuerIdView = findViewById(R.id.issuerIdGift);
        switch (environment) {
            case Constant.ENVIRMENT_EUROPE_RELEASE:
                issuerIdView.setText("101511713");
                passTypeId.setText("hwpass.walletkit.giftcard.srceu");
                passStyleIdentifier.setText("class_giftcard_01");
                break;
            case Constant.ENVIRMENT_AFIRA_RELEASE:
                issuerIdView.setText("101507583");
                passTypeId.setText("hwpass.walletkit.giftcard.src");
                passStyleIdentifier.setText("class_giftcard_01");
                break;
