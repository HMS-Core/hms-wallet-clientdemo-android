...
public class JweUtil {
     ...
     */
    public static String generateJwe(String issuerId, String dataJson,int evn) {
        String jwePrivateKey = Constant.getPrivateKey(evn);
        String sessionKeyPublicKey = Constant.SESSION_KEY_PUBLIC;
